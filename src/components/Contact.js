      ...
      <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-16">
        ...
        <div className="mt-4 sm:mt-6 md:mt-8 lg:mt-12">
          ...
          <Link to="/contact" title="">
            <button className="relative mr-2 inline-flex items-center justify-center px-8 py-3 mt-10 text-base font-semibold text-white bg-black rounded hover:shadow-lg hover:scale-105 transition-transform duration-300">
